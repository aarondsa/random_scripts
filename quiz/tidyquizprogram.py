#document history: quiz --> quizprogram --> quizprogram2 --> quizprogram3.py --> tidyquizprogram
#this script tidies quizprogram3
#it does not have any error checking functions
...
while i < nitems:
    ...
    #note that the answers can be printed 3 times in this script. once as separate print commands, and once as a tuple, and once from dictionary
    #print listanswers #(the second way the answers can be printed)
    #print dictanswers #the third way the answers can be printed

    #script to print dictanswers more tidily
    for q, w in dictanswers.iteritems():
        print w,
        print ': ', 
        print q
    ...
    if int(userans) != int(trueansnumber):
        while int(userans) != int(trueansnumber):
